...
with sync_playwright() as pw:
    ...
    try:
        ...
        page.wait_for_selector('#profile h1');assert '[完顏] 崇厚' in page.locator('#profile h1').inner_text();assert '內務府鑲黃旗' in page.locator('#profile').inner_text();page.screenshot(path=str(a.output/'wanyan-profile.png'))
