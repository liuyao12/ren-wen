...
test('unimported biography retains external ECCP destination',async()=>{const d=eccpDestination(await person('person-li-hongzhang'),{...catalog,sources:[]});assert.equal(d.external,true);assert.equal(d.relation,'principal-biography');});
